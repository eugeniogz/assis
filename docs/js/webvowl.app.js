	  ...
	  function exportTex(){
	    ...
	    nodeElements.each(function ( node ){
	      ...
	      if ( node.type() === "owl:unionOf" ) {
	        ...
	        texString += "\\node[font={\\fontsize{12pt}{12}\\selectfont \\sffamily }" + textColorStr + "] at (" + px + "pt, " + txtOffset + "pt)   (Node_text" + i + ") {" + identifier.replaceAll("_", "\\_ ").replaceAll("-","\\\\") + "};\n";
	      }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(d3) {module.exports = function ( graph ){
	  ...
	  if (DEFAULT_JSON_NAME == undefined) {
		  DEFAULT_JSON_NAME="./gbd/base_revisao";
	  } e lse { DEFAULT_JSON_NAME =  "./gbd/" + DEFAULT_JSON_NAME;}
